...
prostate = h2o.upload_file(r"D:\Data_Analytics\pythonProject1\code\breast-cancer-datasets-and-codes\DB-csv-files\DB2MOD.csv")


prostate.head()

# split into train and testing sets
print("######### Split into train and testing sets!!! ###########")
train, test = prostate.split_frame(ratios = [0.9], seed = 123)
x = train.columns
y = "class"
x.remove(y)
