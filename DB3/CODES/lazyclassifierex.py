...
df = pd.read_csv(r'D:\Data_Analytics\pythonProject1\code\breast-cancer-datasets-and-codes\DB-csv-files\DB3.csv')
...
#results_df.to_csv('DB3_lazypredict_result.csv')