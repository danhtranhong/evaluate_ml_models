...
print("Loading file!!! ")
prostate = h2o.upload_file(r"D:\Data_Analytics\pythonProject1\code\breast-cancer-datasets-and-codes\DB-csv-files\DB6.csv")
...
train, test = prostate.split_frame(ratios = [0.75], seed = 123)
x = train.columns
y = "class"
x.remove(y)
